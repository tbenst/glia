...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["ReceptiveField.Retina2pixel"] = $PS["ReceptiveField.Retina2pixel"] || {};
  var exports = $PS["ReceptiveField.Retina2pixel"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  ...
  var main = function __do() {
      ...
      Effect_Aff.launchAff_(ReceptiveField_Main.preloadImages("retina2pixel/")(32)(32))();
      (function () {
          ...
          throw new Error("Failed pattern match at ReceptiveField.Retina2pixel (line 37, column 3 - line 45, column 16): " + [ maybeElement.constructor.name ]);
      })();
      return Data_Unit.unit;
  };
  exports["scene"] = scene;
...
PS["ReceptiveField.Retina2pixel"].main();